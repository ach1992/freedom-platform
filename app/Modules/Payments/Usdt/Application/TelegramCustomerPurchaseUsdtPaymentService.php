...
final readonly class TelegramCustomerPurchaseUsdtPaymentService implements TelegramCustomerPurchaseUsdtPayment
{
    ...
    /** @requirement BUY-001 BUY-003 PAY-001 PAY-002 PRO-001 USDT-001 USDT-002 USDT-003 DAT-002 DAT-003 SEC-002 QUA-001 */
    public function prepareForSelf(
        ...
        // Rate resolution may perform HTTP; never hold the pre-payment Order lock across it.
    ...
    public function submitTxidForSelf(
        ...
        return $this->database->connection()->transaction(function (Connection $connection) use (
            ...
            if (! in_array($stored->intent_state, [
                PaymentIntentState::AwaitingUserAction->value,
                PaymentIntentState::Submitted->value,
            ], true)) {
                throw new AuthorizationException('Telegram USDT payment is no longer awaiting a TXID.');
            }
    ...
    /** @return object{intent_id:int|string,intent_public_id:string,intent_state:string} */
