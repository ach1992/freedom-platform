...
SET @app_service_batch_authority = NULL,
    @app_service_entitlement_grant_batch_authority = NULL,
    @app_service_entitlement_grant_batch_id = NULL,
    @app_service_entitlement_grant_item_id = NULL,
    @app_service_entitlement_grant_target_authority = NULL,
    @app_service_entitlement_grant_operation_id = NULL,
    @app_service_entitlement_grant_snapshot_hash = NULL,
    @app_service_entitlement_grant_target_expires_at = NULL,
    @app_service_entitlement_grant_target_data_limit = NULL,
    @app_service_entitlement_grant_notification_authority = NULL,
    @app_service_entitlement_grant_notification_item_id = NULL,
    @app_service_entitlement_grant_notification_attempt_id = NULL,
    @app_service_entitlement_grant_notification_retry_ordinal = NULL,
    @app_service_entitlement_grant_notification_presentation_hash = NULL,
