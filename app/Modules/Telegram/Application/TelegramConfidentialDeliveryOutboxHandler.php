...
final readonly class TelegramConfidentialDeliveryOutboxHandler implements OutboxEventHandler
{
    ...
    {
        return TelegramDeliveryQueueService::OUTBOX_CONTRACT_VERSION_CONFIDENTIAL;
    }
