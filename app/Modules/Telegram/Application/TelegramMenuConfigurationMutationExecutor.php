...
final readonly class TelegramMenuConfigurationMutationExecutor
{
    public const MANAGE_PERMISSION = 'telegram.menus.manage';
    ...
    private function validateReplay(
        ...
        if ($receipt->targetType !== $targetType
            ...
            throw new RuntimeException('Telegram menu configuration mutation fingerprint conflict.');
        }
