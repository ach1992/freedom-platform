...
final readonly class TelegramProtectedReferenceDeliveryOutboxHandler implements OutboxEventHandler
{
    ...
    {
        return TelegramDeliveryQueueService::OUTBOX_CONTRACT_VERSION_PROTECTED_REFERENCE;
    }
