...
return new class extends Migration
{
    ...
    private function addChecks(): void
    {
        ...
        DB::statement("ALTER TABLE payment_method_rule_versions ADD CONSTRAINT payment_rule_time_chk CHECK ((`starts_at_utc` IS NULL AND `ends_at_utc` IS NULL) OR (`starts_at_utc` REGEXP '^([01][0-9]|2[0-3]):[0-5][0-9]\$' AND `ends_at_utc` REGEXP '^([01][0-9]|2[0-3]):[0-5][0-9]\$')) )");
