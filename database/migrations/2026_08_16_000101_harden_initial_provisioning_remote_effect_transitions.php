...
BEGIN
    ...
    IF COALESCE(claim_transition, FALSE) = FALSE
       ...
       AND COALESCE(final_transition, FALSE) = FALSE THEN
...
FOR EACH ROW
BEGIN
    SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'Provisioning Operation mutation is fail-closed after remote-effect transition hardening rollback.';
END
SQL);
    }
};
