...
return new class extends Migration
{
    ...
    private function addChecks(): void
    {
        foreach ([
            ...
            ['service_auto_renew_attempts', 'sara_retry_chk', "(`state` IN ('retry_pending','insufficient_wallet') AND `next_retry_at` IS NOT NULL AND `retry_count` >= 1) OR (`state` NOT IN ('retry_pending','insufficient_wallet') AND `next_retry_at` IS NULL)"],
