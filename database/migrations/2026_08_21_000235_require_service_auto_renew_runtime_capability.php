...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::unprepared(<<<'SQL'
CREATE TRIGGER IF NOT EXISTS `sara_cap_insert_guard`
...
SQL);
        DB::unprepared(<<<'SQL'
CREATE TRIGGER IF NOT EXISTS `sara_cap_update_guard`
...
SQL);
        DB::unprepared(<<<'SQL'
CREATE TRIGGER IF NOT EXISTS `sarae_cap_insert_guard`
...
SQL);
        DB::unprepared(<<<'SQL'
CREATE TRIGGER IF NOT EXISTS `sarni_cap_insert_guard`
