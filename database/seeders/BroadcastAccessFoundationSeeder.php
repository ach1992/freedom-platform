...
final class BroadcastAccessFoundationSeeder extends Seeder
{
    public const PERMISSION = 'telegram.broadcasts.manage';

    /** @requirement COM-002 COM-003 ACL-001 ACL-002 SEC-002 */
    public function run(): void
    {
        ...
        if ((! is_int($roleId) && ! is_string($roleId))
            ...
            throw new RuntimeException('Broadcast access seed references an unknown role or permission.');
        }
