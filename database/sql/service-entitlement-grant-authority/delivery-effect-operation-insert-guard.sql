...
BEGIN
    ...
    IF NEW.operation_type IN ('reset_usage','suspend','activate','delete','rotate_subscription_link','renew','add_data','add_days','add_data_days','grant_data','grant_days','grant_data_days','reconfigure') THEN
