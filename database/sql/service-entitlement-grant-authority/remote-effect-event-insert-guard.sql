...
BEGIN
    ...
    WHERE operation_row.id = NEW.provisioning_operation_id
      ...
      AND ((operation_row.operation_type = 'initial_provision'
           ...
           OR (operation_row.operation_type IN ('reset_usage','suspend','activate','delete','rotate_subscription_link','renew','add_data','add_days','add_data_days','grant_data','grant_days','grant_data_days','reconfigure')
