...
|---|---|---|
| `INS-001`, `SEC-007`, `QUA-011` | Installer access boundary, dual PHP runtime preflight, runtime health probe integration, installer preflight UI, `tests/Feature/InstallerAccessBoundaryTest.php`, `tests/Unit/Modules/Installer/PhpRuntimePreflightTest.php`, CI run `30872227771` | Journaled bootstrap/final lock, remaining outbound/disk/ownership checks, target aaPanel/OpenLiteSpeed installation and rollback evidence |
