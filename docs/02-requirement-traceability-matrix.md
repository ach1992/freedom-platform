...
| `RUN-001`, `RUN-003`, `RUN-004`, `QUA-003`, `QUA-004` | health probe/command/endpoints; Scheduler heartbeat; `deploy/cron`; `deploy/supervisor`; CI Compose; tests | aaPanel rehearsal, Supervisor integration, and staging evidence |
