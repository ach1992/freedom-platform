...
- [`06-test-strategy.md`](06-test-strategy.md) — testing, CI, self-hosted runner qualification/lifecycle, and compatibility contract.
...
3. Do not copy mutable SHAs, CI runs, test counts, Worker state, branch inventories, runner display names, host addresses, or live runner inventory into durable docs.
