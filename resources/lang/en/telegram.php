...
This is a recorded commercial snapshot only. No payment, capacity reservation, order, or provisioning has been created yet.',
    ...
    'telegram_phone_verification' => [
        'entry_button' => 'Verify / re-verify phone',
        ...
        'invalid_phone' => 'That phone number could not be accepted. Check the Iranian mobile number and try again.',
        'contact_invalid' => 'That contact could not be verified as your own Telegram contact, or the number is unavailable.',
        'otp_unavailable' => 'SMS verification is temporarily unavailable for this Update. Start the flow again so abuse-control evidence can be established.',
        'otp_rate_limited' => 'Too many verification requests were made. Please try again after the current limit window.',
        'otp_invalid' => 'The verification code is invalid. Check the 6-digit code and try again.',
        'otp_expired' => 'That verification challenge is no longer active. Enter the phone number again to request a new code.',
        'success' => 'Phone verification completed successfully.',
    ],
    'client_guides' => [
