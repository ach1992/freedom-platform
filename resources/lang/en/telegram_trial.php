...
return [
    ...
    'queued' => "Your Trial was accepted and queued for provisioning.\n\nService ID: :service\nData: :data\nDuration: :duration days\nFinal server: :server\nProtocol: :protocol\nFallback: :fallback\n\nProvider creation is performed separately through the protected provisioning queue. Connection details will be delivered through the protected delivery path after the service is ready.",
    'fallback' => [
