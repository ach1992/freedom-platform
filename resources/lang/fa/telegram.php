...
متنی را که می‌خواهید برای این مشتری ارسال شود بفرستید. تا مرحله تأیید نهایی هیچ پیامی ارسال نمی‌شود.',
                'message_invalid' => 'یک پیام متنی غیرخالی با حداکثر ۴۰۹۶ نویسه ارسال کنید.',
...
متن دقیق پیام بلافاصله در پیام بالایی نمایش داده شده است. برای ثبت یک‌باره ارسال، تأیید کنید.',
