...
این پیش‌فاکتور فقط یک snapshot تجاری ثبت‌شده است. هنوز هیچ پرداخت، رزرو ظرفیت، سفارش یا پروویژنینگی ایجاد نشده است.',
            ...
            'payment_methods' => [
                ...
                'card_to_card_payment' => [
                    ...
                    'instructions' => "راهنمای پرداخت کارت‌به‌کارت\n\nمبلغ دقیق قابل پرداخت: :amount :currency\nکارت مقصد: :masked_card\nمهلت پرداخت: :expires_at (زمان تهران)\nپایان بازه بررسی دیرهنگام: :late_review_until (زمان تهران)\n\nدقیقاً همان مبلغ نمایش‌داده‌شده را انتقال دهید؛ افزایش جزئی مبلغ عمدی است و نباید گرد شود. شماره کامل کارت جداگانه و فقط از مسیر محافظت‌شده با دکمه کپی ارسال می‌شود. پرداخت پس از مهلت ممکن است به‌صورت خودکار تطبیق داده نشود و به بررسی دستی نیاز داشته باشد. ارسال رسید در این مرحله هنوز فعال نیست.",
                    'copy_message' => 'برای کپی شماره کارت مقصد از دکمه محافظت‌شده زیر استفاده کنید. پیش از انتقال، مبلغ دقیق و شماره کارت ماسک‌شده در راهنمای پرداخت را بررسی کنید.',
                    'copy_button' => 'کپی شماره کارت مقصد',
                ],
                'wallet_payment' => [
